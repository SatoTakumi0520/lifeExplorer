...
typeの定義(時間で何が起きるかを単一軸とした6カテゴリ):
- "work":    経済義務として外に出す(本業、副業、業務)
- "create":  自発的に外に出す(創作、発信、ボランティア)
- "study":   外から取り込む(勉強、読書、講座、内省)
- "care":    自分を保つ(食事、睡眠、運動、瞑想、家事)
- "enjoy":   一人で解放する(趣味、エンタメ、散策、ぼんやり)
- "connect": 他者と共有する(家族、友人、コミュニティ)
