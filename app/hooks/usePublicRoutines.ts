...
const DEMO_PUBLIC_ROUTINES: PublicRoutine[] = [
  {
    ...
    category: 'wellness',
    routineTasks: [
      { time: '06:00', endTime: '06:30', title: 'Morning Yoga', thought: '太陽礼拝で体を目覚めさせる', type: 'enjoy' },
      { time: '06:30', endTime: '07:00', title: '読書タイム', thought: '好きな本を30分', type: 'study' },
      { time: '09:00', endTime: '12:00', title: 'フォーカスワーク', thought: '午前中に集中タスクを片付ける', type: 'work' },
      { time: '12:30', endTime: '13:00', title: 'ランチ散歩', thought: '外の空気を吸って気分転換', type: 'enjoy' },
    ],
    likesCount: 12,
  ...
  },
  {
    ...
    routineTasks: [
      { time: '07:00', endTime: '07:30', title: 'ジャーナリング', thought: '今日のゴールを3つ書き出す', type: 'study' },
      { time: '08:00', endTime: '11:00', title: 'Deep Coding', thought: 'SlackオフでコードにDive', type: 'work' },
      { time: '11:00', endTime: '11:15', title: 'ストレッチ', thought: '肩と腰を伸ばす', type: 'enjoy' },
  ...
  },
  {
    ...
    category: 'parenting',
    routineTasks: [
      { time: '05:30', endTime: '06:30', title: '自分時間', thought: '子供が起きる前の貴重な1時間', type: 'study' },
      ...
      { time: '15:00', endTime: '16:00', title: '公園タイム', thought: 'お迎え後に外遊び', type: 'enjoy' },
    ],
    likesCount: 15,
