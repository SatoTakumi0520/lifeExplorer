...
function getCuratedEvents(): EventItem[] {
  ...
  const rawEvents: EventItem[] = [
    // ── オンライン（全国共通）
    {
      ...
      routineSuggestion: { time: '06:45', endTime: '08:00', title: 'オンライン朝活参加', thought: '全国の仲間と朝をスタートする。', type: 'study' },
    ...
    },
    {
      ...
      routineSuggestion: { time: '21:45', endTime: '22:30', title: 'オンライン瞑想セッション', thought: '一日の終わりに心を静める。', type: 'study' },
    ...
    },
    {
      ...
      routineSuggestion: { time: '19:30', endTime: '22:00', title: 'オンライン読書会', thought: '本を通じて全国の仲間と繋がる夜。', type: 'study' },
    ...
    // ── 東京都
    {
      ...
      routineSuggestion: { time: '06:30', endTime: '08:30', title: '森林浴ウォーキング（代々木公園）', thought: '自然の中を歩いて心をリセットする朝。', type: 'enjoy' },
    ...
    },
    {
      ...
      routineSuggestion: { time: '05:45', endTime: '07:30', title: '皇居ランニング', thought: '朝の空気の中を走って一日をスタートする。', type: 'enjoy' },
    ...
    // ── 大阪府
    {
      ...
      routineSuggestion: { time: '06:30', endTime: '08:30', title: '大阪城公園ヨガ', thought: '城を見ながら心と体を整える朝。', type: 'enjoy' },
    ...
    // ── 愛知県
    {
      ...
      routineSuggestion: { time: '06:00', endTime: '08:00', title: '名城公園ランニング', thought: '緑の中を走って名古屋の朝を楽しむ。', type: 'enjoy' },
    ...
    // ── 福岡県
    {
      ...
      routineSuggestion: { time: '05:45', endTime: '07:30', title: '大濠公園ラン', thought: '池の朝靄の中を走る爽快な朝。', type: 'enjoy' },
    ...
    // ── 京都府
    {
      ...
      routineSuggestion: { time: '06:00', endTime: '09:00', title: '嵐山 禅ウォーキング', thought: '観光客のいない京都で内面と向き合う朝。', type: 'study' },
    ...
    // ── 神奈川県
    {
      ...
      routineSuggestion: { time: '05:30', endTime: '07:30', title: '円覚寺 坐禅体験', thought: '鎌倉の古刹で無心になる早朝。', type: 'study' },
